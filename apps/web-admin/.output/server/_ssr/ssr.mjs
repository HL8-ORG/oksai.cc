...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-O4Iep2ah.mjs");
...
async function loadEntries() {
	const routerEntry = await import("./router-DcK8ihAy.mjs");
	return {
