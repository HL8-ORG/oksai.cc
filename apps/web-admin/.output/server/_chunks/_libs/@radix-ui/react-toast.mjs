...
import {
  ...
  r as createContextScope,
  i as require_jsx_runtime,
  s as require_react,
  o as useComposedRefs,
} from "./react-collection.mjs";
import {
  t as Branch,
  a as dispatchDiscreteCustomEvent,
  i as Primitive,
  n as Root,
  o as require_react_dom,
  r as useCallbackRef,
} from "./react-dismissable-layer.mjs";
import { t as Portal, n as useLayoutEffect2 } from "./react-portal.mjs";
import { t as Presence } from "./react-presence.mjs";
...
var ToastViewport = import_react.forwardRef((props, forwardedRef) => {
  ...
  const getSortedTabbableCandidates = import_react.useCallback(
    ({ tabbingDirection }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Branch, {
    ...
    children: [
      hasToasts &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusProxy, {
...
var ToastImpl = import_react.forwardRef((props, forwardedRef) => {
  ...
  const startTimer = import_react.useCallback(
    (duration2) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [
      announceTextContent &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToastAnnounce, {
          __scopeToast,
          role: "status",
...
export { Root2 as a, Provider as i, Close as n, Title as o, Description as r, Viewport as s, Action as t };
