...
import { t as __commonJSMin, i as __toESM } from "../../../_runtime.mjs";
...
var require_react_production = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  exports.__COMPILER_RUNTIME = {
    __proto__: null,
    c: (size) => ReactSharedInternals.H.useMemoCache(size),
  };
  exports.cache = (fn) =>
    function () {
  ...
  exports.createRef = () => ({ current: null });
  ...
  exports.unstable_useCacheRefresh = () => ReactSharedInternals.H.useCacheRefresh();
  exports.use = (usable) => ReactSharedInternals.H.use(usable);
  exports.useActionState = (action, initialState, permalink) =>
    ReactSharedInternals.H.useActionState(action, initialState, permalink);
  exports.useCallback = (callback, deps) => ReactSharedInternals.H.useCallback(callback, deps);
  exports.useContext = (Context) => ReactSharedInternals.H.useContext(Context);
  ...
  exports.useEffect = (create, deps) => ReactSharedInternals.H.useEffect(create, deps);
  exports.useEffectEvent = (callback) => ReactSharedInternals.H.useEffectEvent(callback);
  exports.useId = () => ReactSharedInternals.H.useId();
  exports.useImperativeHandle = (ref, create, deps) =>
    ReactSharedInternals.H.useImperativeHandle(ref, create, deps);
  exports.useInsertionEffect = (create, deps) => ReactSharedInternals.H.useInsertionEffect(create, deps);
  exports.useLayoutEffect = (create, deps) => ReactSharedInternals.H.useLayoutEffect(create, deps);
  exports.useMemo = (create, deps) => ReactSharedInternals.H.useMemo(create, deps);
  ...
  exports.useRef = (initialValue) => ReactSharedInternals.H.useRef(initialValue);
  exports.useState = (initialState) => ReactSharedInternals.H.useState(initialState);
  ...
  exports.useTransition = () => ReactSharedInternals.H.useTransition();
...
export {
  composeRefs as a,
  require_jsx_runtime as i,
  createSlot as n,
  useComposedRefs as o,
  createContextScope as r,
  require_react as s,
  createCollection as t,
};
