...
function getGraphQLError() {
  if (!GraphQLErrorClass) {
    try {
      ...
      throw new Error("graphql is required for GraphQL support. Please install it: npm install graphql");
    }
  }
...
export class AuthGuard implements CanActivate {
   ...
   */
  private matchesRequiredRole(role: string | string[] | undefined, requiredRoles: string[]): boolean {
