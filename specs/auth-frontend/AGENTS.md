# AGENTS.md — 认证前端对齐（Auth Frontend）

## 项目背景

对齐后端已实现的认证功能到前端，包括登录、注册、邮箱验证、密码重置、2FA 设置、OAuth 登录等完整认证流程。

## 开始前

1. 阅读 `specs/auth-frontend/design.md` 了解完整的技术设计和用户流程
2. 阅读 `specs/authentication/design.md` 了解后端认证功能实现
3. 查看 `specs/auth-frontend/implementation.md` 了解当前进度
4. 参考 `specs/_templates-frontend/workflow.md` 了解前端开发工作流程
5. 参考 `apps/web-admin/src/routes/` 中的现有路由实现
